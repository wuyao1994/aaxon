...
@Component
public class AccountRegisterFormValidator implements Validator {
    private static final Logger LOGGER = LoggerFactory.getLogger(AccountRegisterFormValidator.class);
